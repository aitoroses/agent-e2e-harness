...
import type { VerifySuiteReport } from '@agent-e2e/harness/verify';
...
type VerifyReportHasSuiteId = Expect<Equal<VerifySuiteReport['suiteId'], string>>;

export type PublicImportContract = RootSurfaceIsDefaultHarnessApi | CoreSurfaceIsHarnessCore | VerifyReportHasSuiteId;
